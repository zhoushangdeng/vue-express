export function collapseProps(): {
    ...
    activeKey: import("vue-types").VueTypeDef<string | number | import("../../_util/type").Key[]>;
    defaultActiveKey: import("vue-types").VueTypeDef<string | number | import("../../_util/type").Key[]>;
