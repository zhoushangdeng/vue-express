...
export namespace propTypes {
    const percent_1: import("vue-types").VueTypeDef<string | number | import("../../_util/type").Key[]>;
...
declare const mixedType: import("vue-types").VueTypeDef<import("../../_util/type").Key>;
export {};
