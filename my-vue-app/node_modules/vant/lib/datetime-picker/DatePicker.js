...
var [createComponent] = (0, _utils.createNamespace)('date-picker');
...
var _default = createComponent({
  ...
  setup(props, {
    ...
    var originColumns = (0, _vue.computed)(() => ranges.value.map(({
      ...
      var values = (0, _utils2.times)(rangeArr[1] - rangeArr[0] + 1, index => {
    ...
    (0, _vue.watch)(currentDate, (value, oldValue) => {
