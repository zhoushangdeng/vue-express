...
import type { IPopperOptions, PopperInstance } from 'element-plus/lib/el-popper/src/use-popper/defaults';
...
export * from 'element-plus/lib/el-popper/src/use-popper/defaults';
