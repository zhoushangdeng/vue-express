...
import type { Direction } from 'element-plus/lib/el-virtual-list/src/useVirtualScroll';
declare const _default: import("vue").DefineComponent<{
    ...
    scrollTo: (idx: number, alignment?: import("element-plus/lib/el-virtual-list/src/useVirtualScroll").Alignment) => void;
