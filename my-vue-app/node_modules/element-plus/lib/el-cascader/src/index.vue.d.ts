...
import type { CascaderValue, CascaderNode, Tag } from 'element-plus/lib/el-cascader-panel';
declare const _default: import("vue").DefineComponent<{
    ...
    options: {
        type: PropType<import("element-plus/lib/el-cascader-panel").CascaderOption[]>;
        default: () => import("element-plus/lib/el-cascader-panel").CascaderOption[];
    };
    props: {
        type: PropType<import("element-plus/lib/el-cascader-panel").CascaderProps>;
        default: () => import("element-plus/lib/el-cascader-panel").CascaderProps;
    };
}, {
    popperOptions: {
        modifiers: {
    ...
    popperClass: string;
    options: import("element-plus/lib/el-cascader-panel").CascaderOption[];
    props: import("element-plus/lib/el-cascader-panel").CascaderProps;
} & {
    size?: ComponentSize;
    modelValue?: string | number | import("element-plus/lib/el-cascader-panel").CascaderNodePathValue | (string | number | import("element-plus/lib/el-cascader-panel").CascaderNodePathValue)[] | (string & {}) | (number & {});
}>, {
    placeholder: string;
    disabled: boolean;
    clearable: boolean;
